...
function ChangeExcursionDate({ showChangeDate, setShowChangeDate, fexcursion }) {
        ...
        >
            <Modal.Body>
                ...
                <div className={deleteConfirm}>
                    Change date to &quot;{fexcursion.name}&quot; excursion
                </div>
                ...
                <div className={deleteModalBtns}>
                    ...
                    <Button
                        variant="warning"
                        onClick={() => changeDateHandler(fexcursion._id)}
                    >
                        Change Date
                    </Button>
                </div>
...
export default ChangeExcursionDate;
